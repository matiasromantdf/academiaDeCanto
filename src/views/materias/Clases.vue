<template>
  <div class="container py-5">
    ...
    <div class="accordion" id="accordionClases">
      <div v-for="(clase, index) in clasesFiltradas" :key="clase.id" class="accordion-item">
        <h2 class="accordion-header" :id="'heading' + clase.id">
          <button class="accordion-button" :class="{ collapsed: index !== 0 }" type="button" data-bs-toggle="collapse"
            :data-bs-target="'#collapse' + clase.id" :aria-expanded="index === 0 ? 'true' : 'false'"
        ...
        <div :id="'collapse' + clase.id" class="accordion-collapse collapse" :class="{ show: index === 0 }"
          :aria-labelledby="'heading' + clase.id" data-bs-parent="#accordionClases">
          <div class="accordion-body">
            ...
            <ul class="nav nav-tabs mb-3" :id="'tabs-' + clase.id" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" :id="'pdf-tab-' + clase.id" data-bs-toggle="tab"
                  :data-bs-target="'#pdf-' + clase.id" type="button" role="tab">PDF</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" :id="'video-tab-' + clase.id" data-bs-toggle="tab"
                  :data-bs-target="'#video-' + clase.id" type="button" role="tab">Video</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" :id="'quiz-tab-' + clase.id" data-bs-toggle="tab"
                  :data-bs-target="'#quiz-' + clase.id" type="button" role="tab">Cuestionario</button>
              </li>
            </ul>
